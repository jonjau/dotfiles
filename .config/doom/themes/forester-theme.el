;;; forester.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme forester "Theme using Template variables with quality of life improvements.")

;; Define all the color variables (replaced by template processor)
(let* ((bg "#1c1e1a")
      (err "#ce7a71")
      (err-container "#6e261f")
      (on-background "#f4f6eb")
      (on-err "#131411")
      (on-err-container "#f2dbd9")
      (on-primary "#131411")
      (on-primary-container "#e6eae1")
      (on-secondary "#131411")
      (on-secondary-container "#e9e8e2")
      (on-surface "#f4f6eb")
      ...
      (secondary "#948e74")
      (secondary-container "#363220")
      (shadow "#0a0a09")
      (surface "#1c1e1a")
      (surface-container "#252722")
      (surface-container-high "#2f322c")
      (surface-container-highest "#3a3d35")
      (surface-container-low "#20221e")
      (surface-container-lowest "#1d1f1b")
      (surface-variant "#252722")
      (tertiary "#6e857b")
      (tertiary-container "#1d2f27")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#6e857b")
      (on-success "#f4f6eb")
      (success-container "#1d2f27")
      (on-success-container "#e3e8e6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#a2b08d")
      (primary-fixed-dim "#495a30")
      (secondary-fixed "#948e74")
      (secondary-fixed-dim "#363220")
      (tertiary-fixed "#6e857b")
      (tertiary-fixed-dim "#1d2f27")
      (on-primary-fixed "#131411")
      (on-primary-fixed-variant "#e6eae1")
      (on-secondary-fixed "#131411")
      (on-secondary-fixed-variant "#e9e8e2")
      (on-tertiary-fixed "#f4f6eb")
      (on-tertiary-fixed-variant "#e3e8e6")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f4f6eb")
      (inverse-primary "#a2b08d")
      (inverse-surface "#1c1e1a")
